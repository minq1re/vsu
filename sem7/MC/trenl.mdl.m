...
Model {
  Version  10.5
  Description "Simulink model saved in R2022a"
}
__MWOPC_PACKAGE_BEGIN__ R2022a
...
<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">
  ...
  <Override ContentType="application/vnd.mathworks.simulink.graphicalInterface+xml" PartName="/simulink/graphicalInterface.xml"/>
  <Override ContentType="application/vnd.mathworks.simulink.mf0+xml" PartName="/simulink/modelDictionary.xml"/>
  <Override ContentType="application/vnd.mathworks.simulink.ScheduleCore+xml" PartName="/simulink/ScheduleCore.xml"/>
  <Override ContentType="application/vnd.mathworks.simulink.ScheduleEditor+xml" PartName="/simulink/ScheduleEditor.xml"/>
  <Override ContentType="application/vnd.mathworks.stateflow.machine+xml" PartName="/simulink/stateflow/machine.xml"/>
...
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcmitype="http://purl.org/dc/dcmitype/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <cp:category>model</cp:category>
  <dcterms:created xsi:type="dcterms:W3CDTF">2025-11-05T18:32:41Z</dcterms:created>
  <dc:creator>sssss</dc:creator>
  <cp:lastModifiedBy>Веточка</cp:lastModifiedBy>
  <dcterms:modified xsi:type="dcterms:W3CDTF">2025-11-26T17:04:13Z</dcterms:modified>
  <cp:revision>1.17</cp:revision>
  <cp:version>R2022a</cp:version>
</cp:coreProperties>
...
<mwcoreProperties xmlns="http://schemas.mathworks.com/package/2014/corePropertiesExtension">
  <uuid>229cf3d3-d596-4bf3-a86d-805159f2047f</uuid>
</mwcoreProperties>
...
<MathWorks_version_info>
  ...
  <checksum>915613965</checksum>
</MathWorks_version_info>

__MWOPC_PART_BEGIN__ /simulink/_rels/blockdiagram.xml.rels
<?xml version="1.0" encoding="UTF-8" standalone="yes" ?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="ScheduleCore" Target="ScheduleCore.xml" Type="http://schemas.mathworks.com/simulink/2013/relationships/ScheduleCore"/>
  <Relationship Id="ScheduleEditor" Target="ScheduleEditor.xml" Type="http://schemas.mathworks.com/simulink/2013/relationships/ScheduleEditor"/>
  <Relationship Id="graphicalInterface" Target="graphicalInterface.xml" Type="http://schemas.mathworks.com/simulinkModel/2014/relationships/graphicalInterface"/>
  <Relationship Id="stateflow_machine" Target="stateflow/machine.xml" Type="http://schemas.mathworks.com/simulinkModel/2014/relationships/stateflowMachine"/>
...
<ModelInformation Version="1.0">
  <Model>
    <P Name="ModelUUID">3d754118-177a-4c47-96e5-215653d32e6b</P>
    <P Name="LastSavedArchitecture">win64</P>
    <ConfigManagerSettings>
      <P Name="ModifiedByFormat">%&lt;Auto&gt;</P>
      <P Name="ModifiedDateFormat">%&lt;Auto&gt;</P>
      <P Name="RTWModifiedTimeStamp">686088230</P>
      <P Name="ModelVersionFormat">%&lt;AutoIncrement:1.17&gt;</P>
    </ConfigManagerSettings>
    <SimulationSettings>
      <P Name="SimulationMode">normal</P>
      <Object PropName="DataLoggingOverride" ObjectID="1" ClassName="Simulink.SimulationData.ModelLoggingInfo">
        <P Name="model_" Class="char">$bdroot</P>
        <P Name="overrideMode_" Class="uint32">0U</P>
        <Array PropName="logAsSpecifiedByModels_" Type="Cell" Dimension="1*1">
          <Cell Class="char">$bdroot</Cell>
        </Array>
    ...
    <ConcurrentExecutionSettings>
      <Object PropName="DataTransfer" ObjectID="2" ClassName="Simulink.GlobalDataTransfer">
...
<?xml version="1.0" encoding="utf-8"?>
<ConfigSet>
  <Object Version="22.0.0" ClassName="Simulink.ConfigSet">
    <P Name="DisabledProps" Class="double">[]</P>
    <P Name="Description"/>
    <Array PropName="Components" Type="Handle" Dimension="1*9">
      <Object ObjectID="2" Version="22.0.0" ClassName="Simulink.SolverCC">
        <P Name="DisabledProps" Class="double">[]</P>
        <P Name="Description"/>
        ...
        <P Name="EnableMultiTasking">off</P>
        <P Name="AllowMultiTaskInputOutput">off</P>
        <P Name="ConcurrentTasks">off</P>
        <P Name="SolverName">FixedStepDiscrete</P>
        ...
        <P Name="AlgebraicLoopSolver">Auto</P>
        <P Name="SolverInfoToggleStatus">on</P>
      ...
      <Object ObjectID="3" Version="22.0.0" ClassName="Simulink.DataIOCC">
        <P Name="DisabledProps" Class="double">[]</P>
        <P Name="Description"/>
        <P Name="Components" Class="double">[]</P>
        ...
        <P Name="SaveFormat">Dataset</P>
        <P Name="SignalLoggingSaveFormat">Dataset</P>
        ...
        <P Name="ReturnWorkspaceOutputs">on</P>
      ...
      <Object ObjectID="4" Version="22.0.0" ClassName="Simulink.OptimizationCC">
        <Array PropName="DisabledProps" Type="Cell" Dimension="1*9">
        ...
        <P Name="ExpressionDepthLimit">128</P>
      ...
      <Object ObjectID="5" Version="22.0.0" ClassName="Simulink.DebuggingCC">
        ...
        <P Name="UnderspecifiedInitializationDetection">Simplified</P>
        <P Name="MergeDetectMultiDrivingBlocksExec">error</P>
        ...
        <P Name="SolverPrmCheckMsg">none</P>
        ...
        <P Name="FcnCallInpInsideContextMsg">error</P>
        <P Name="SignalLabelMismatchMsg">none</P>
        <P Name="UnconnectedInputMsg">none</P>
        <P Name="UnconnectedOutputMsg">none</P>
        <P Name="UnconnectedLineMsg">none</P>
        ...
        <P Name="SFUnexpectedBacktrackingDiag">error</P>
        <P Name="SFInvalidInputDataAccessInChartInitDiag">warning</P>
        <P Name="SFNoUnconditionalDefaultTransitionDiag">error</P>
        ...
        <P Name="SFExecutionAtInitializationDiag">warning</P>
        <P Name="SFMachineParentedDataDiag">error</P>
        ...
        <P Name="ArithmeticOperatorsInVariantConditions">error</P>
        <P Name="VariantConditionMismatch">none</P>
      </Object>
      <Object ObjectID="6" Version="22.0.0" ClassName="Simulink.HardwareCC">
        <P Name="DisabledProps" Class="double">[]</P>
        <P Name="Description"/>
        <P Name="Components" Class="double">[]</P>
        ...
        <P Name="ProdBitPerPointer">64</P>
        <P Name="ProdBitPerSizeT">64</P>
        <P Name="ProdBitPerPtrDiffT">64</P>
        <P Name="ProdLargestAtomicInteger">Char</P>
        <P Name="ProdLargestAtomicFloat">Float</P>
        <P Name="ProdIntDivRoundTo">Zero</P>
        <P Name="ProdEndianess">LittleEndian</P>
        <P Name="ProdWordSize">64</P>
        <P Name="ProdShiftRightIntArith">on</P>
        <P Name="ProdLongLongMode">off</P>
        <P Name="ProdHWDeviceType">Intel-&gt;x86-64 (Windows64)</P>
      ...
      <Object ObjectID="7" Version="22.0.0" ClassName="Simulink.ModelReferenceCC">
        <P Name="DisabledProps" Class="double">[]</P>
        <P Name="Description"/>
        <P Name="Components" Class="double">[]</P>
        ...
        <P Name="PropagateSignalLabelsOutOfModel">on</P>
        <P Name="SupportModelReferenceSimTargetCustomCode">off</P>
        <P Name="UseModelRefSolver">off</P>
      </Object>
      <Object ObjectID="8" Version="22.0.0" ClassName="Simulink.SFSimCC">
        <P Name="DisabledProps" Class="double">[]</P>
        <P Name="Description"/>
        <P Name="Components" Class="double">[]</P>
        ...
        <P Name="SimUseLocalCustomCode">on</P>
        ...
        <P Name="CustomCodeUndefinedFunction">FilterOut</P>
      ...
      <Object BackupClass="Simulink.RTWCC" ObjectID="9" Version="22.0.0" ClassName="Simulink.RTWCC">
        <Array PropName="DisabledProps" Type="Cell" Dimension="1*17">
          ...
          <Cell Class="char">CodeExecutionProfiling</Cell>
          <Cell Class="char">CodeProfilingSaveOptions</Cell>
        ...
        <P Name="RTWUseLocalCustomCode">on</P>
        ...
        <Array PropName="Components" Type="Handle" Dimension="1*2">
          <Object ObjectID="10" Version="22.0.0" ClassName="Simulink.CodeAppCC">
            ...
            <P Name="StateflowObjectComments">off</P>
          ...
          <Object BackupClass="Simulink.TargetCC" ObjectID="11" Version="22.0.0" ClassName="Simulink.GRTTargetCC">
            <Array PropName="DisabledProps" Type="Cell" Dimension="1*19">
            ...
            <P Name="TargetLangStandard">C99 (ISO)</P>
            ...
            <P Name="CombineOutputUpdateFcns">on</P>
      ...
      <Object ObjectID="12" Version="22.0.0" ClassName="SlCovCC.ConfigComp">
        <P Name="DisabledProps" Class="double">[]</P>
        ...
        <P Name="CovCompData"/>
        <P Name="CovMetricSettings">dwe</P>
        <P Name="CovFilter"/>
        ...
        <P Name="CovSaveCumulativeToWorkspaceVar">off</P>
        <P Name="CovSaveSingleToWorkspaceVar">off</P>
        ...
        <P Name="CovExternalEMLEnable">on</P>
        <P Name="CovSFcnEnable">on</P>
    ...
    <P Name="ConfigPrmDlgPosition">[ 566, 84, 900, 710 ]</P>
    <P Name="ExtraOptions"/>
  </Object>
</ConfigSet>
...
<GraphicalInterface>
  ...
  <P Name="PreCompExecutionDomainType">Unset</P>
  <P Name="UseModelRefSolver">0</P>
  <P Name="SolverName">FixedStepDiscrete</P>
  <P Name="IsExportFunctionModel">0</P>
  <P Name="SimulinkSubDomainType">Simulink</P>
  <P Name="NumParameterArguments">0</P>
  <P Name="NumExternalFileReferences">2</P>
  <ExternalFileReference>
    <P Name="Reference">commanapbnd3/DSB AM
Demodulator
Passband</P>
    <P Name="Path">$bdroot/DSB AM Demodulator Passband</P>
    <P Name="SID">21</P>
    <P Name="Type">LIBRARY_BLOCK</P>
  </ExternalFileReference>
  <ExternalFileReference>
    <P Name="Reference">commanapbnd3/DSB AM
Modulator
Passband</P>
    <P Name="Path">$bdroot/DSB AM Modulator Passband</P>
    <P Name="SID">3</P>
    <P Name="Type">LIBRARY_BLOCK</P>
  </ExternalFileReference>
...
<?xml version="1.0" encoding="UTF-8"?>
<MF0 version="1.1" defaultPackage="slid" packageUris="http://schema.mathworks.com/mf0/slid/R2020b_20191110">
  <System type="System" uuid="8ceba22e-7362-4b18-ab62-65af689a1eff">
    <Interface type="Interface" uuid="2b6f665b-1318-4421-bdef-44acc00498f7"/>
  </System>
</MF0>
__MWOPC_PART_BEGIN__ /simulink/ScheduleCore.xml
<?xml version="1.0" encoding="UTF-8"?>
<sltp_graph version="1.1" packageUris="http://schema.mathworks.com/mf0/sltp_mm/R2021b_202106150630">
  <sltp.mm.core.Context type="sltp.mm.core.Context" uuid="d6b4d110-2fdd-426a-8b49-92e7d880f65f">
    <priorityDirection>HighNumberLast</priorityDirection>
    <editorState type="sltp.mm.core.EditorState" uuid="cd5b5fb8-674e-43ba-a729-ac2f21e8a07a">
      <isSynchronized>true</isSynchronized>
      <panelState type="sltp.mm.core.EditorPanelState" uuid="087ee299-35f7-41ee-9fb4-d8d0c6d7323e"/>
    </editorState>
    <rootTask type="sltp.mm.core.Task" uuid="8f8e1b45-43ee-4ee7-8621-45c4600fd7b0">
      <context type="sltp.mm.core.Context" uuid="d6b4d110-2fdd-426a-8b49-92e7d880f65f"/>
      <explicit>false</explicit>
      <name>Default</name>
      <priority>-2147483648</priority>
      <subgraph type="sltp.mm.core.Graph" uuid="cbee466b-dfdc-4dcb-a2e6-96d2a82eba52">
        <tasks type="sltp.mm.core.Task" uuid="48b9ee39-03db-429d-ac78-54e2713acc6d">
          ...
          <rates type="sltp.mm.core.Rate" uuid="b1282b7c-5fde-4609-b91c-b6bb9c308b0a">
          ...
          <rates type="sltp.mm.core.Rate" uuid="20688b39-6a68-4c04-b591-ec33f6ae5049">
  ...
  </sltp.mm.core.Context>
</sltp_graph>
__MWOPC_PART_BEGIN__ /simulink/ScheduleEditor.xml
<?xml version="1.0" encoding="UTF-8"?>
<sltp_editor version="1.1" packageUris="http://schema.mathworks.com/mf0/DiagramEditor/R2019a_20181107 http://schema.mathworks.com/mf0/SltpSyntax/R2022a_202109161050">
  <sltp.mm.syntax.Context type="sltp.mm.syntax.Context" uuid="f1bbc8a1-3ad2-4077-9235-32278ef6060b">
    <rootGraph type="sltp.mm.syntax.Graph" uuid="a71b13ba-ccb6-4844-af8b-ea0278ad1b5d">
      <children type="sltp.mm.syntax.Node" uuid="60649b97-d900-4ab0-a6d0-4637ca8c9314">
        <priority>40</priority>
        <rates type="sltp.mm.syntax.RateData">
          <color>#000000</color>
          <hasBlocks>true</hasBlocks>
          <rate>0</rate>
          <title>Cont</title>
        ...
        <title>Cont</title>
        <type>base</type>
        <diagramElement type="diagram.editor.model.Entity" uuid="68cac83c-ea1c-44fc-884d-21a5baeced8b"/>
        <subgraph type="sltp.mm.syntax.Graph" uuid="14fc223a-1952-4fc9-8377-b445918205e7">
          <title>Cont</title>
          <diagramElement type="diagram.editor.model.Diagram" uuid="bf611981-a19a-4e9d-b460-6016df14e26d"/>
        </subgraph>
      </children>
      <title>Default</title>
      <diagramElement type="diagram.editor.model.Diagram" uuid="d6ef6f64-3a44-4007-aa09-7a2f74268107"/>
    </rootGraph>
  </sltp.mm.syntax.Context>
  <diagram.editor.model.Diagram type="diagram.editor.model.Diagram" uuid="d6ef6f64-3a44-4007-aa09-7a2f74268107">
    <entities type="diagram.editor.model.Entity" uuid="68cac83c-ea1c-44fc-884d-21a5baeced8b">
      <position>0,0</position>
      <size>0,0,0,0</size>
      <syntaxElement type="sltp.mm.syntax.Node" uuid="60649b97-d900-4ab0-a6d0-4637ca8c9314"/>
      <title>Cont</title>
      <type>base</type>
      <subDiagram type="diagram.editor.model.Diagram" uuid="bf611981-a19a-4e9d-b460-6016df14e26d">
        <position>0,0</position>
        <syntaxElement type="sltp.mm.syntax.Graph" uuid="14fc223a-1952-4fc9-8377-b445918205e7"/>
        <title>Cont</title>
        <type>graph.Graph</type>
      </subDiagram>
    </entities>
    <syntaxElement type="sltp.mm.syntax.Graph" uuid="a71b13ba-ccb6-4844-af8b-ea0278ad1b5d"/>
    <title>Default</title>
    <type>graph.Graph</type>
  </diagram.editor.model.Diagram>
</sltp_editor>
__MWOPC_PART_BEGIN__ /simulink/stateflow/machine.xml
<?xml version="1.0" encoding="utf-8"?>
<Stateflow>
  <machine id="1">
    <P Name="sfVersion">80000049</P>
    <Children>
...
<System>
  ...
  <Block BlockType="Reference" Name="DSB AM&#xA;Demodulator&#xA;Passband" SID="21">
    <P Name="Ports">[1, 1]</P>
    <P Name="Position">[730, 165, 805, 215]</P>
    <P Name="ZOrder">288</P>
    <P Name="LibraryVersion">5.0</P>
    <P Name="SourceBlock">commanapbnd3/DSB AM
Demodulator
Passband</P>
    <P Name="SourceType">DSB AM Demodulator Passband</P>
  ...
  <Block BlockType="Reference" Name="DSB AM&#xA;Modulator&#xA;Passband" SID="3">
    <P Name="Ports">[1, 1]</P>
    <P Name="Position">[405, 165, 480, 215]</P>
    <P Name="ZOrder">3</P>
    <P Name="LibraryVersion">5.0</P>
    <P Name="SourceBlock">commanapbnd3/DSB AM
Modulator
Passband</P>
    <P Name="SourceType">DSB AM Modulator Passband</P>
    <P Name="SourceProductBaseCode">CM</P>
    <InstanceData>
      <P Name="RTWMemSecFuncInitTerm">Inherit from model</P>
      <P Name="RTWMemSecFuncExecute">Inherit from model</P>
  ...
  <Block BlockType="MATLABFcn" Name="Interpreted MATLAB&#xA;Function" SID="11">
    <P Name="Ports">[1, 1]</P>
    <P Name="Position">[325, 300, 395, 330]</P>
    <P Name="ZOrder">11</P>
    <P Name="MATLABFcn">double(u &gt; Am/2)</P>
    <P Name="Output1D">off</P>
  </Block>
  <Block BlockType="MATLABFcn" Name="Interpreted MATLAB&#xA;Function1" SID="12">
    <P Name="Ports">[1, 1]</P>
    <P Name="Position">[540, 175, 610, 205]</P>
    <P Name="ZOrder">12</P>
    <P Name="MATLABFcn">u/(sqrt(4*pi)*R)</P>
    <P Name="Output1D">off</P>
  </Block>
  <Block BlockType="MATLABFcn" Name="Interpreted MATLAB&#xA;Function2" SID="14">
    <P Name="Ports">[1, 1]</P>
    <P Name="Position">[860, 175, 930, 205]</P>
    <P Name="ZOrder">14</P>
    <P Name="MATLABFcn">double(u &gt; (mr*sqrt(NP)))</P>
    <P Name="Output1D">off</P>
  </Block>
  <Block BlockType="RandomNumber" Name="Random&#xA;Number" SID="6">
    <P Name="Position">[580, 240, 620, 280]</P>
    <P Name="ZOrder">6</P>
    <P Name="Variance">NP</P>
    <P Name="Seed">to</P>
    <P Name="SampleTime">Ts</P>
  </Block>
  <Block BlockType="Scope" Name="Scope" SID="5">
    <P Name="Ports">[3]</P>
    <P Name="Position">[845, 69, 890, 131]</P>
    <P Name="ZOrder">5</P>
    <P Name="ScopeSpecificationString">Simulink.scopes.TimeScopeBlockCfg(&apos;CurrentConfiguration&apos;, extmgr.ConfigurationSet(extmgr.Configuration(&apos;Core&apos;,&apos;General UI&apos;,true),extmgr.Configuration(&apos;Core&apos;,&apos;Source UI&apos;,true),extmgr.Configuration(&apos;Sources&apos;,&apos;WiredSimulink&apos;,true),extmgr.Configuration(&apos;Visuals&apos;,&apos;Time Domain&apos;,true,&apos;SerializedDisplays&apos;,{struct(&apos;MinYLimReal&apos;,&apos;-0.125&apos;,&apos;MaxYLimReal&apos;,&apos;1.125&apos;,&apos;YLabelReal&apos;,&apos;&apos;,&apos;MinYLimMag&apos;,&apos;0.00000&apos;,&apos;MaxYLimMag&apos;,&apos;1.125&apos;,&apos;LegendVisibility&apos;,&apos;Off&apos;,&apos;XGrid&apos;,true,&apos;YGrid&apos;,true,&apos;PlotMagPhase&apos;,false,&apos;AxesColor&apos;,[0 0 0],&apos;AxesTickColor&apos;,[0.686274509803922 0.686274509803922 0.686274509803922],&apos;ColorOrder&apos;,[1 1 0.0666666666666667;0.0745098039215686 0.623529411764706 1;1 0.411764705882353 0.16078431372549;0.392156862745098 0.831372549019608 0.0745098039215686;0.717647058823529 0.274509803921569 1;0.0588235294117647 1 1;1 0.0745098039215686 0.650980392156863],&apos;Title&apos;,&apos;%&lt;SignalLabel&gt;&apos;,&apos;LinePropertiesCache&apos;,{{}},&apos;UserDefinedChannelNames&apos;,{{}},&apos;NumLines&apos;,1,&apos;LineNames&apos;,{{&apos;Interpreted MATLAB Function3&apos;}},&apos;ShowContent&apos;,true,&apos;Placement&apos;,1),struct(&apos;MinYLimReal&apos;,&apos;-1.03514&apos;,&apos;MaxYLimReal&apos;,&apos;1.22613&apos;,&apos;YLabelReal&apos;,&apos;&apos;,&apos;MinYLimMag&apos;,&apos; 0.00000&apos;,&apos;MaxYLimMag&apos;,&apos;488.75&apos;,&apos;LegendVisibility&apos;,&apos;off&apos;,&apos;XGrid&apos;,true,&apos;YGrid&apos;,true,&apos;PlotMagPhase&apos;,false,&apos;AxesColor&apos;,[0 0 0],&apos;AxesTickColor&apos;,[0.686274509803922 0.686274509803922 0.686274509803922],&apos;ColorOrder&apos;,[1 1 0.0666666666666667;0.0745098039215686 0.623529411764706 1;1 0.411764705882353 0.16078431372549;0.392156862745098 0.831372549019608 0.0745098039215686;0.717647058823529 0.274509803921569 1;0.0588235294117647 1 1;1 0.0745098039215686 0.650980392156863],&apos;Title&apos;,&apos;%&lt;SignalLabel&gt;&apos;,&apos;LinePropertiesCache&apos;,{{}},&apos;UserDefinedChannelNames&apos;,{{}},&apos;NumLines&apos;,1,&apos;LineNames&apos;,{{&apos;DSB AM Modulator Passband&apos;}},&apos;ShowContent&apos;,true,&apos;Placement&apos;,2),struct(&apos;MinYLimReal&apos;,&apos;-0.85966&apos;,&apos;MaxYLimReal&apos;,&apos;0.81383&apos;,&apos;YLabelReal&apos;,&apos;&apos;,&apos;MinYLimMag&apos;,&apos; 0.00000&apos;,&apos;MaxYLimMag&apos;,&apos;488.74023&apos;,&apos;LegendVisibility&apos;,&apos;off&apos;,&apos;XGrid&apos;,true,&apos;YGrid&apos;,true,&apos;PlotMagPhase&apos;,false,&apos;AxesColor&apos;,[0 0 0],&apos;AxesTickColor&apos;,[0.686274509803922 0.686274509803922 0.686274509803922],&apos;ColorOrder&apos;,[1 1 0.0666666666666667;0.0745098039215686 0.623529411764706 1;1 0.411764705882353 0.16078431372549;0.392156862745098 0.831372549019608 0.0745098039215686;0.717647058823529 0.274509803921569 1;0.0588235294117647 1 1;1 0.0745098039215686 0.650980392156863],&apos;Title&apos;,&apos;%&lt;SignalLabel&gt;&apos;,&apos;LinePropertiesCache&apos;,{{}},&apos;UserDefinedChannelNames&apos;,{{}},&apos;NumLines&apos;,1,&apos;LineNames&apos;,{{&apos;Sum&apos;}},&apos;ShowContent&apos;,true,&apos;Placement&apos;,3)},&apos;DisplayPropertyDefaults&apos;,struct(&apos;YLabelReal&apos;,&apos;&apos;,&apos;AxesColor&apos;,[0 0 0],&apos;AxesTickColor&apos;,[0.686274509803922 0.686274509803922 0.686274509803922],&apos;ColorOrder&apos;,[0.0745098039215686 0.623529411764706 1;1 0.411764705882353 0.16078431372549;1 1 0.0666666666666667;0.717647058823529 0.274509803921569 1;0.392156862745098 0.831372549019608 0.0745098039215686;0.0588235294117647 1 1;1 0.0745098039215686 0.650980392156863]),&apos;DisplayLayoutDimensions&apos;,[3 1]),extmgr.Configuration(&apos;Tools&apos;,&apos;Plot Navigation&apos;,true),extmgr.Configuration(&apos;Tools&apos;,&apos;Measurements&apos;,true,&apos;Version&apos;,&apos;2022a&apos;)),&apos;Version&apos;,&apos;2022a&apos;,&apos;Position&apos;,[442.6 293 928 420])</P>
    <P Name="NumInputPorts">3</P>
    <P Name="Floating">off</P>
  </Block>
  <Block BlockType="Scope" Name="Scope1" SID="7">
    <P Name="Ports">[3]</P>
    <P Name="Position">[935, 318, 975, 372]</P>
    <P Name="ZOrder">7</P>
    <P Name="ScopeSpecificationString">Simulink.scopes.TimeScopeBlockCfg(&apos;CurrentConfiguration&apos;, extmgr.ConfigurationSet(extmgr.Configuration(&apos;Core&apos;,&apos;General UI&apos;,true),extmgr.Configuration(&apos;Core&apos;,&apos;Source UI&apos;,true),extmgr.Configuration(&apos;Sources&apos;,&apos;WiredSimulink&apos;,true,&apos;DataLoggingVariableName&apos;,&apos;ScopeData1&apos;),extmgr.Configuration(&apos;Visuals&apos;,&apos;Time Domain&apos;,true,&apos;SerializedDisplays&apos;,{struct(&apos;MinYLimReal&apos;,&apos;0.27555&apos;,&apos;MaxYLimReal&apos;,&apos;0.55454&apos;,&apos;YLabelReal&apos;,&apos;&apos;,&apos;MinYLimMag&apos;,&apos;0.27555&apos;,&apos;MaxYLimMag&apos;,&apos;0.55454&apos;,&apos;LegendVisibility&apos;,&apos;Off&apos;,&apos;XGrid&apos;,true,&apos;YGrid&apos;,true,&apos;PlotMagPhase&apos;,false,&apos;AxesColor&apos;,[0 0 0],&apos;AxesTickColor&apos;,[0.686274509803922 0.686274509803922 0.686274509803922],&apos;ColorOrder&apos;,[1 1 0.0666666666666667;0.0745098039215686 0.623529411764706 1;1 0.411764705882353 0.16078431372549;0.392156862745098 0.831372549019608 0.0745098039215686;0.717647058823529 0.274509803921569 1;0.0588235294117647 1 1;1 0.0745098039215686 0.650980392156863],&apos;Title&apos;,&apos;%&lt;SignalLabel&gt;&apos;,&apos;LinePropertiesCache&apos;,{{}},&apos;UserDefinedChannelNames&apos;,{{}},&apos;NumLines&apos;,1,&apos;LineNames&apos;,{{&apos;Interpreted MATLAB Function&apos;}},&apos;ShowContent&apos;,true,&apos;Placement&apos;,1),struct(&apos;MinYLimReal&apos;,&apos;-0.125&apos;,&apos;MaxYLimReal&apos;,&apos;1.125&apos;,&apos;YLabelReal&apos;,&apos;&apos;,&apos;MinYLimMag&apos;,&apos;0.00000&apos;,&apos;MaxYLimMag&apos;,&apos;1.44262&apos;,&apos;LegendVisibility&apos;,&apos;off&apos;,&apos;XGrid&apos;,true,&apos;YGrid&apos;,true,&apos;PlotMagPhase&apos;,false,&apos;AxesColor&apos;,[0 0 0],&apos;AxesTickColor&apos;,[0.686274509803922 0.686274509803922 0.686274509803922],&apos;ColorOrder&apos;,[1 1 0.0666666666666667;0.0745098039215686 0.623529411764706 1;1 0.411764705882353 0.16078431372549;0.392156862745098 0.831372549019608 0.0745098039215686;0.717647058823529 0.274509803921569 1;0.0588235294117647 1 1;1 0.0745098039215686 0.650980392156863],&apos;Title&apos;,&apos;%&lt;SignalLabel&gt;&apos;,&apos;LinePropertiesCache&apos;,{{}},&apos;UserDefinedChannelNames&apos;,{{}},&apos;NumLines&apos;,1,&apos;LineNames&apos;,{{&apos;Interpreted MATLAB Function2&apos;}},&apos;ShowContent&apos;,true,&apos;Placement&apos;,2),struct(&apos;MinYLimReal&apos;,&apos;-4.29506&apos;,&apos;MaxYLimReal&apos;,&apos;4.4292&apos;,&apos;YLabelReal&apos;,&apos;&apos;,&apos;MinYLimMag&apos;,&apos;0.00000&apos;,&apos;MaxYLimMag&apos;,&apos;1.44262&apos;,&apos;LegendVisibility&apos;,&apos;off&apos;,&apos;XGrid&apos;,true,&apos;YGrid&apos;,true,&apos;PlotMagPhase&apos;,false,&apos;AxesColor&apos;,[0 0 0],&apos;AxesTickColor&apos;,[0.686274509803922 0.686274509803922 0.686274509803922],&apos;ColorOrder&apos;,[1 1 0.0666666666666667;0.0745098039215686 0.623529411764706 1;1 0.411764705882353 0.16078431372549;0.392156862745098 0.831372549019608 0.0745098039215686;0.717647058823529 0.274509803921569 1;0.0588235294117647 1 1;1 0.0745098039215686 0.650980392156863],&apos;Title&apos;,&apos;%&lt;SignalLabel&gt;&apos;,&apos;LinePropertiesCache&apos;,{{}},&apos;UserDefinedChannelNames&apos;,{{}},&apos;NumLines&apos;,1,&apos;LineNames&apos;,{{&apos;DSB AM Demodulator Passband&apos;}},&apos;ShowContent&apos;,true,&apos;Placement&apos;,3)},&apos;DisplayPropertyDefaults&apos;,struct(&apos;YLabelReal&apos;,&apos;&apos;,&apos;AxesColor&apos;,[0 0 0],&apos;AxesTickColor&apos;,[0.686274509803922 0.686274509803922 0.686274509803922],&apos;ColorOrder&apos;,[0.0745098039215686 0.623529411764706 1;1 0.411764705882353 0.16078431372549;1 1 0.0666666666666667;0.717647058823529 0.274509803921569 1;0.392156862745098 0.831372549019608 0.0745098039215686;0.0588235294117647 1 1;1 0.0745098039215686 0.650980392156863]),&apos;DisplayLayoutDimensions&apos;,[3 1]),extmgr.Configuration(&apos;Tools&apos;,&apos;Plot Navigation&apos;,true,&apos;OnceAtStop&apos;,false,&apos;PreviousZoomMode&apos;,&apos;ZoomY&apos;),extmgr.Configuration(&apos;Tools&apos;,&apos;Measurements&apos;,true,&apos;Version&apos;,&apos;2022a&apos;)),&apos;Version&apos;,&apos;2022a&apos;,&apos;Position&apos;,[344.2 304.2 836 380])</P>
    <P Name="NumInputPorts">3</P>
    <P Name="Floating">off</P>
  </Block>
  <Block BlockType="SignalGenerator" Name="Signal&#xA;Generator" SID="20">
    <P Name="Ports">[0, 1]</P>
    <P Name="Position">[135, 180, 165, 210]</P>
    <P Name="ZOrder">287</P>
    <P Name="Amplitude">Am</P>
    <P Name="Frequency">20</P>
  </Block>
  <Block BlockType="Sum" Name="Sum" SID="13">
    <P Name="Ports">[2, 1]</P>
    <P Name="Position">[670, 180, 690, 200]</P>
    <P Name="ZOrder">13</P>
    <P Name="Inputs">|++</P>
  </Block>
  <Block BlockType="ToWorkspace" Name="To Workspace" SID="9">
    <P Name="Ports">[1]</P>
    <P Name="Position">[980, 175, 1070, 205]</P>
    <P Name="ZOrder">9</P>
    <P Name="VariableName">simout1</P>
    <P Name="MaxDataPoints">inf</P>
    <P Name="Save2DSignal">2-D array (concatenate along first dimension)</P>
    <P Name="FixptAsFi">on</P>
    <P Name="SampleTime">-1</P>
  </Block>
  <Block BlockType="ToWorkspace" Name="To Workspace1" SID="10">
    <P Name="Ports">[1]</P>
    <P Name="Position">[485, 375, 575, 405]</P>
    <P Name="ZOrder">10</P>
    <P Name="VariableName">simout</P>
    <P Name="MaxDataPoints">inf</P>
    <P Name="Save2DSignal">2-D array (concatenate along first dimension)</P>
    <P Name="FixptAsFi">on</P>
    <P Name="SampleTime">-1</P>
  ...
  <Block BlockType="TransportDelay" Name="Transport&#xA;Delay" SID="1">
    <P Name="Ports">[1, 1]</P>
    <P Name="Position">[230, 175, 270, 215]</P>
    <P Name="ZOrder">1</P>
    <P Name="DelayTime">0</P>
    <P Name="BufferSize">10240</P>
  </Block>
  <Block BlockType="ZeroOrderHold" Name="Zero-Order&#xA;Hold" SID="30">
    <P Name="Position">[300, 180, 335, 210]</P>
    <P Name="ZOrder">290</P>
    <P Name="SampleTime">Ts</P>
  </Block>
  <Line>
  ...
  <Line>
    ...
    <Branch>
      <P Name="ZOrder">34</P>
      <P Name="Points">[3, 0; 0, 77; -57, 0; 0, 78]</P>
      <P Name="Dst">7#in:2</P>
    </Branch>
    <Branch>
      <P Name="ZOrder">28</P>
  ...
  <Line>
    ...
    <Branch>
      <P Name="ZOrder">4</P>
      <P Name="Points">[0, 63; -68, 0; 0, 57]</P>
...
<WindowsInfo>
  <Object PropName="BdWindowsInfo" ObjectID="1" ClassName="Simulink.BDWindowsInfo">
    <Object PropName="WindowsInfo" ObjectID="2" ClassName="Simulink.WindowInfo">
      ...
      <P Name="Location" Class="double">[-7.0, -7.0, 1550.0, 838.0]</P>
      <Object PropName="ModelBrowserInfo" ObjectID="3" ClassName="Simulink.ModelBrowserInfo">
        ...
        <P Name="Minimized" Class="char">On</P>
      </Object>
      <Object PropName="ExplorerBarInfo" ObjectID="4" ClassName="Simulink.ExplorerBarInfo">
        <P Name="Visible" Class="logical">1</P>
      </Object>
      <Array PropName="EditorsInfo" Type="Simulink.EditorInfo" Dimension="1*5">
        <Object ObjectID="5">
          <P Name="IsActive" Class="logical">1</P>
          <P Name="IsTabbed" Class="logical">1</P>
          <P Name="ViewObjType" Class="char">SimulinkTopLevel</P>
          <P Name="LoadSaveID" Class="char">0</P>
          <P Name="Extents" Class="double">[1807.0, 754.0]</P>
          <P Name="ZoomFactor" Class="double">1.25</P>
          <P Name="Offset" Class="double">[41.8863422420947, 3.0972545988511748]</P>
          <P Name="SceneRectInView" Class="double">[41.8863422420947, 3.0972545988511748, 1156.48, 482.56]</P>
        </Object>
        <Object ObjectID="6">
          <P Name="IsActive" Class="logical">0</P>
          <P Name="IsTabbed" Class="logical">0</P>
          <P Name="ViewObjType" Class="char">SimulinkSubsys</P>
          <P Name="LoadSaveID" Class="char">21:4</P>
          <P Name="Extents" Class="double">[1875.0, 744.0]</P>
          <P Name="ZoomFactor" Class="double">1.0</P>
          <P Name="Offset" Class="double">[-340.0, -156.10000000000002]</P>
          <P Name="SceneRectInView" Class="double">[-340.0, -156.10000000000002, 1500.0, 595.2]</P>
        </Object>
        <Object ObjectID="7">
          <P Name="IsActive" Class="logical">0</P>
          <P Name="IsTabbed" Class="logical">0</P>
          <P Name="ViewObjType" Class="char">StudioAdapterBlock</P>
          <P Name="LoadSaveID" Class="char">29</P>
          <P Name="Extents" Class="double">[1737.0, 858.0]</P>
          <P Name="ZoomFactor" Class="double">1.0</P>
        ...
        <Object ObjectID="8">
          ...
          <P Name="IsTabbed" Class="logical">0</P>
          <P Name="ViewObjType" Class="char">StudioAdapterBlock</P>
          <P Name="LoadSaveID" Class="char">23</P>
          <P Name="Extents" Class="double">[1737.0, 807.0]</P>
          <P Name="ZoomFactor" Class="double">1.0</P>
          <P Name="Offset" Class="double">[0.0, 0.0]</P>
          <P Name="SceneRectInView" Class="double">[0.0, 0.0, 0.0, 0.0]</P>
        </Object>
        <Object ObjectID="9">
          ...
          <P Name="IsTabbed" Class="logical">0</P>
          <P Name="ViewObjType" Class="char">StudioAdapterBlock</P>
          <P Name="LoadSaveID" Class="char">17</P>
          <P Name="Extents" Class="double">[949.0, 797.0]</P>
          <P Name="ZoomFactor" Class="double">1.0</P>
          <P Name="Offset" Class="double">[0.0, 0.0]</P>
          <P Name="SceneRectInView" Class="double">[0.0, 0.0, 0.0, 0.0]</P>
        </Object>
      ...
      <Array PropName="DockComponentsInfo" Type="Simulink.DockComponentInfo" Dimension="1*2">
        <Object ObjectID="10">
          ...
          <P Name="Width" Class="int32">512</P>
          <P Name="Height" Class="int32">384</P>
          <P Name="Minimized" Class="char">On</P>
        </Object>
        <Object ObjectID="11">
