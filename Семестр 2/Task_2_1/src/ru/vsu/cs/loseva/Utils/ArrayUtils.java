...
//    public static String toStringL(List<Integer> arr2, String itemFormat) {
//        StringBuilder sb = new StringBuilder();
//        if (arr2 == null){
//            return null;
//        }
...
//                sb.append(System.lineSeparator());
//            }
//            sb.append(toStringL(arr2.get(r), itemFormat));
//        }
//        return sb.toString();
//    }
    ...
    /**
     *
     * Чтение листа из тесктового файла, i - номер строки
     *
     */
    public static List<Integer> readListFromFile(String fileName, int i) {
        try {
            return toList(readLinesFromFile(fileName)[i]);
        }
        catch(FileNotFoundException e) {
            return null;
        }
    ...
    public static int[] fromListIntoArray(List<Integer> list) {
    ...
    public static List<Integer> fromArrayIntoList(int[] array) {
        List<Integer> list = new ArrayList<>();
